# 🧠 Transformers Calculation Methodology
...
**Transformers Network** is a **fully interactive, real-time visualization** of the **Transformer architecture** running **100% in the browser** using **HTML, CSS, JavaScript, and TensorFlow.js**.
